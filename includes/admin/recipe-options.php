  ...
  ?> 
      ...
      <div class="form-group">
          ...
          <select class="form-control" name="r_inputLevel">
              ...
              <option value="Intermediate" value="<?php echo $recipe_data['level'] == "Intermediate" ? "SELECTED" : ""; ?>">Intermediate</option>
              <option value="Expert" value="<?php echo $recipe_data['level'] == "Expert" ? "SELECTED" : ""; ?>">Expert</option>
          </select>
      </div>
      <div class="form-group">
